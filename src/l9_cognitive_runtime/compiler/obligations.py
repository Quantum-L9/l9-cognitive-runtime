...
class ObligationDeriver:
    ...
    def derive(
        ...
        # Non-blocking unknowns stay visible in the compiled context and packet
        # without creating an obligation — that is what non-material means.
            ...
            for context_unknown in task_context.unresolved_unknowns:
                ...
                obligations.append(
                    Obligation(
                        ...
                        consumer_refs=["handoff_contract"],
                        evidence_requirements=[
                            "resolution or governed disposition of "
                            f"{context_unknown.reason_code.value}"
                        ],
                    )
                )
